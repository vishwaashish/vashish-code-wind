...
# KeyFilter Utility Documentation

The **KeyFilter** utility provides input validation for `input` and `textarea` fields by filtering keyboard events, paste operations, and input events using predefined or custom regular expressions.
