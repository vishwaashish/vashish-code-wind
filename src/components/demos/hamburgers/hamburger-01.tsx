      ...
      <button aria-label="Toggle menu">
        ...
        >
          ...
          <line
            ...
            strokeWidth="2"
            strokeLinecap="round"
            className="origin-center transition-all duration-300 group-hover:-rotate-45"
          />
          <line
            x1="4"
            y1="18"
            ...
            strokeWidth="2"
            strokeLinecap="round"
            className="origin-center transition-all duration-300 group-hover:-translate-y-[2px] group-hover:translate-x-[6px] group-hover:rotate-45"
          />
        </svg>
      </button>
    </div>
