    ...
    {items.map((item) => (
      <li key={item.label}>
        <Link
          href={item.url}
          className={cn(
            "block rounded py-2 pl-3 pr-4 text-black/50 transition-all hover:text-[#4f39f6] focus:text-[#4f39f6] focus:outline-0 dark:text-white/80 dark:hover:text-[#4f39f6] dark:focus:text-[#4f39f6] lg:p-0",
            item.active &&
...
const MobileMenu = ({ items }: { items: MenuItem[] }) => {
  ...
  return (
    <Sheet>
      <SheetTrigger aria-label="Open main menu" className="block lg:hidden">
      ...
      <SheetContent
        showClose={false}
        side="left"
        className="flex h-full max-w-xs flex-col gap-0 p-0"
      >
        <SheetTitle className="sr-only">Mobile Menu Dialog</SheetTitle>
              ...
              <li key={item.label}>
                <SheetClose asChild>
                  <Link
                    href={item.url}
                    className={cn(
                      "block rounded px-6 py-3 font-medium text-black/50 transition-all hover:text-[#4f39f6] focus:text-[#4f39f6] focus:outline-0 dark:text-white/80 dark:hover:text-[#4f39f6] dark:focus:text-[#4f39f6]",
                      item.active &&
                        "font-bold text-[#4f39f6] hover:text-[#4f39f6] dark:text-[#4f39f6]",
                    )}
                  >
        ...
        <div className="mt-auto w-full space-y-6 px-6 py-6">
          <ul className="flex max-w-xs flex-wrap justify-between gap-2">
            {socialList.map((item) => (
              <li key={item.label}>
                <Link
                  className="block rounded-full border border-black/10 p-3 text-black/50 transition-all hover:border-[#4f39f6] hover:text-[#4f39f6] focus:border-[#4f39f6] focus:text-[#4f39f6] focus:outline-0 dark:border-white/50 dark:text-white/80 dark:hover:border-[#4f39f6] dark:hover:text-[#4f39f6] dark:focus:border-[#4f39f6] dark:focus:text-[#4f39f6]"
                  href={item.url}
                >
                  {item.icon}
                </Link>
          ...
          <button className="w-full rounded-full bg-[#4f39f6] px-4 py-2 text-sm font-medium text-white focus:outline-none focus:ring-2">
            Get started
          </button>
        </div>
      </SheetContent>
  ...
  return (
    <div>
      ...
      <div className="">
        ...
        <section
          id="contact"
          className="grid h-[400px] place-content-center bg-orange-100 text-2xl font-bold text-black/30"
        >
          Contact
        </section>
      </div>
          ...
          <Content className="fixed inset-y-0 left-0 z-50 flex h-full w-full max-w-xs flex-col overflow-auto border-r bg-background shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left">
            ...
            <div className="mt-auto w-full space-y-6 px-6 py-6">
              <ul className="flex max-w-xs flex-wrap justify-between gap-2">
                <li>
                  <Link
                    className="block rounded-full border border-black/10 p-3 text-black/50 transition-all hover-[#4f39f6]ack/95 hover:text-black/95 focus:text-black/95 focus:outline-0 dark:border-white/50 dark:text-white/80 dark:hover:text-white/95 dark:focus:text-white/95"
                    href="#"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
...
export { fullScreen, HeaderDemo, html, react, title };
